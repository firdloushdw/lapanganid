export let Create = () => (
    <section className="mt-[56px]">
        <div className="flex items-center justify-center">
            <img src="public/img/bapak-bola.png" alt="" />
        </div>

        <div className="flex items-center justify-center mt-[56px] flex-col">
            ...
            <form className="flex items-center gap-[119px] mb-[98px]">
                <div>
                    <div className="shrink-0">
                        <img className="h-[206px] w-[206px]" src="public/img/ellipse.svg" alt="Current profile photo" />
                    </div>
                ...
                <div className="flex flex-col gap-[12px]">
                    <label for="nama-komunitas" className="text-[#91D36E]">Nama Komunitas</label>
                    <input
                        type="text"
